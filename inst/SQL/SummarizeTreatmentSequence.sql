...
IF OBJECT_ID('@resultsSchema.@studyName_drug_seq_summary', 'U') IS NOT NULL
	DROP TABLE @resultsSchema.@studyName_drug_seq_summary;

-- Summarize the unique treatment sequences observed
CREATE TABLE @resultsSchema.@studyName_drug_seq_summary
(
index_year INT,
...
IF OBJECT_ID('@resultsSchema.@studyName_summary', 'U') IS NOT NULL
DROP TABLE @resultsSchema.@studyName_summary;

CREATE TABLE @resultsSchema.@studyName_summary
(
count_type VARCHAR (500),
num_persons INT
);

INSERT INTO @resultsSchema.@studyName_summary (count_type, num_persons)
SELECT
...
FROM @resultsSchema.@studyName_targetcohort;
...
IF OBJECT_ID('@resultsSchema.@studyName_person_cnt', 'U') IS NOT NULL
DROP TABLE @resultsSchema.@studyName_person_cnt;

CREATE TABLE @resultsSchema.@studyName_person_cnt
(
index_year INT,
num_persons INT
);

INSERT INTO @resultsSchema.@studyName_person_cnt (index_year, num_persons)
SELECT
  index_year,
  num_persons
FROM
...
-- Count duration
IF OBJECT_ID('@resultsSchema.@studyName_duration_cnt', 'U') IS NOT NULL
DROP TABLE @resultsSchema.@studyName_duration_cnt;
